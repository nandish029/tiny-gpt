...
def main():
    ...
    if os.path.exists(checkpoint_path) and not args.overwrite and not args.resume:
        print(f"Error: Checkpoint {checkpoint_path} already exists. Use --overwrite to replace it, or --resume to continue training.")
        sys.exit(1)
